...
export default function ImportPage() {
  ...
  async function loadSummary() {
    try {
      // pega só pra mostrar "já tem dados"
  ...
  async function onImport() {
    ...
    setLoading(true);
    try {
      const r = await importGrid(file, sheet /* backend atual usa sheet */);
      setToast({
        id: safeUUID(),
        type: "success",
  ...
  return (
    <motion.div className="space-y-6" variants={container} initial="hidden" animate="show">
      ...
      >
        ...
        {/* mode está aqui para quando seu backend estiver com merge/replace.
            Se ainda não estiver, você pode esconder este bloco. */}
